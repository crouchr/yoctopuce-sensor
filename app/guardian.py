...
# Original code taken (and modified) from https://github.com/SpikedCola/OpenBluelabConnect
# This code must be run as root
# This was abandoned in favour of running th eofficial Blielab client and tailing the csv file logs.
...
def build_packet(command, randomByte):
    ...
    data = bytearray([
        0x00, 0x02,
        # byteArrayLenPlusOne # shit, had 1 here for a long time, should be 2 (command + randomByte) # should actually be len(cmd+random+data) but we dont support data :)
...
def data_receive_callback(xbee_message):
    print('entered data_receive_callback()')
